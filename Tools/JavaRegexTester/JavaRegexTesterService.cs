...
namespace DevToolbox.Tools.JavaRegexTester
{
    ...
    /// tested without touching WinForms. This is a pragmatic approximation of java.util.regex
    /// backed by .NET's own Regex engine (there is no Java runtime available here) - see the
    /// note surfaced in JavaRegexTesterControl for the caveats that come with that.
    /// </summary>
    public static class JavaRegexTesterService
    {
